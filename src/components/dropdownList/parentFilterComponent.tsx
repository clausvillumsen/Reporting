        ...
        return (
            <div className="dropdown part " ref={this.node}>
                ...
                <div className="displayBox" onClick={() => this.registerClick()}>
                    ...
                    {this.state.popupVisible ? <i className="fa fa-chevron-up fa-lg" /> : <i className="fa fa-chevron-down fa-lg" />}
                </div>
                {this.state.popupVisible && (
                    <div className="popover" style={{display: "flex", flexDirection: "column"}}>
                        <FilterComponent
                            onSelectedFilter={(selectedModel: FilterData) =>
                                this.handleSelectedFilter(selectedModel)
                            }
                        />
                        <div className="labelHeader" style={{marginLeft: 30, marginRight: 30}}>SØG PÅ BRUGER ATTRIBUTER</div>
                        <input
