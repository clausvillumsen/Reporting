...
export class CalendarSelect extends React.Component<CalendarProps, CalendarState>  {
    constructor(props: any) {
        super(props)
        this.state = new CalendarState(this.props.startDate, this.props.endDate, null)
    }
    render() {
        moment.locale('da')
    ...
    renderCalendarInfo = () => {
        return (<div className="dateRangeHeaderContainer">
    ...
    handleDateChange = (date: any): any => {
        this.setState(prev => { return { ...prev, startDate: date.startDate, endDate: date.endDate } })
